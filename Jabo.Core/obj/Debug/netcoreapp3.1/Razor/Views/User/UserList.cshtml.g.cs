#pragma checksum "D:\git\DotNetCore\Jabo.Core\Views\User\UserList.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "696ba604ba8a450e26d6638664ee67957120872f"
// <auto-generated/>
...
namespace AspNetCore
{
    ...
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"696ba604ba8a450e26d6638664ee67957120872f", @"/Views/User/UserList.cshtml")]
    ...
    layui.use(['form', 'table', 'miniPage', 'element'], function () {
      ...
      ");
            WriteLiteral(@"      cols: [[
                ...
                { field: 'createDate', width: '15%', title: '创建日期', align: 'center', templet: ""<div>{{layui.util.toDateString(d.sbj_start, 'yyyy-MM-dd')}}</div>""  },
        ...
        table.on('toolbar(currentTableFilter)', function (obj) {
            if (obj.event === 'add') {   // 监听添加操作
                ...
                var checkStatus = table.checkStatus('currentTableId')
                    , dat");
            WriteLiteral(@"a = checkStatus.data;
