#pragma checksum "D:\git\DotNetCore\Jabo.Core\Views\User\UserList.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "2d0445a0e875fb4502618d985528bd3e5a67aad0"
// <auto-generated/>
...
namespace AspNetCore
{
    ...
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"2d0445a0e875fb4502618d985528bd3e5a67aad0", @"/Views/User/UserList.cshtml")]
    ...
    layui.use(['form', 'table', 'miniPage', 'element'], function () {
      ...
      ");
            WriteLiteral(@"      cols: [[
                ...
                { field: 'userName', width: '20%', title: '用户账号', align: 'center' },
                { field: 'displayName', width: '20%', title: '用户名称', align: 'center' },
                { field: 'sex', width: '20%', title: '性别', align: 'center' },
        ...
        table.on('toolbar(currentTableFilter)', function (obj) {
            if (obj.event === 'add') {   // 监听添加操作
                ...
                if (data.length === 0) {
              ");
            WriteLiteral(@"      layer.alert('请选择要删除的用户');
                    return
                }
