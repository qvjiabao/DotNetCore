#pragma checksum "D:\git\DotNetCore\Jabo.Core\Views\OrderZWYS\OrderList.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "1f4784a11c686d8401eccf262e729b17824ddd3f"
// <auto-generated/>
...
namespace AspNetCore
{
    ...
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"1f4784a11c686d8401eccf262e729b17824ddd3f", @"/Views/OrderZWYS/OrderList.cshtml")]
    ...
    layui.use(['form', 'table', 'mini");
        ...
        table.on('toolbar(currentTableFilter)', function (obj) {
            ...
            WriteLiteral(@" === 'exports') {
                ...
                var url = '/OrderZWYS/Export?' + $.param(data1);
                console.log(url);
                window.open(url);
            }
        });
        ...
        table.on('tool(currentTableFilter)', function (obj) {
            ...
            if (obj.event === 'edit') {
                ...
                layer");
            WriteLiteral(@".confirm('您确定删除吗？', function (index) {
                    $.post(""/OrderZWYS/RemoveOrderZWYSByCode"", { list: [data] }, function (json) {
                        if (json.Result) {
                            table.reload('currentTableId');
                        } else {
