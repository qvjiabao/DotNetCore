#pragma checksum "D:\git\DotNetCore\Jabo.Core\Views\OrderZWYS\OrderList.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "b56e1220163c6e3d7653ee07876a1e17d69d7ea3"
// <auto-generated/>
...
namespace AspNetCore
{
    ...
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"b56e1220163c6e3d7653ee07876a1e17d69d7ea3", @"/Views/OrderZWYS/OrderList.cshtml")]
    ...
    <div class=""layuimini-main"">
        ...
        <fieldset class=""table-search-fieldset"">
            ...
            BeginWriteAttribute("action", " action=\"", 271, "\"", 280, 0);
            EndWriteAttribute();
            WriteLiteral(@">
...
<script>
    layui.use(['form', 'table', 'miniPage', 'element','laydate'], function () {
        ...
        table.render({
            ...
            toolbar: '#t");
            WriteLiteral(@"oolbarDemo',
            defaultToolbar: ['exports'],
            cols: [[
                { type: ""checkbox"", width: '5%', fixed: 'left' },
                { type: ""numbers"", width: '5%', title: '序号', fixed: 'left' },
                { field: 'orderNo', width: '15%', title: '订单号', align: 'center' },
                { field: 'cYBNo', width: '18%', title: '仓易宝单号', align: 'center' },
                { field: 'franchiseStore', width: '18%', title: '专营店号', align: 'center' },
                ...
                { field: 'createDate', w");
            WriteLiteral(@"idth: '10%', title: '创建日期', align: 'center', templet: ""<div>{{layui.util.toDateString(d.createDate, 'yyyy-MM-dd')}}</div>""  },
...
");
        ...
        table.on('tool(currentTableFilter)', function (obj) {
            ...
            WriteLiteral(@" shade: 0.2,
                    shadeClose: true,
                    area: ['800px', '400px'],
                    content: ""/OrderZWYS/UserSave#/userCode="" + data.userCode,
                });
                $(window).on(""resize"", function () {
                    layer.full(index);
                });
