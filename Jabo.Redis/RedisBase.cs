...
namespace Jabo.Redis
{
    ...
    {/// <summary>
     ...
     /// <returns></returns>
        ...
        static RedisHelper()
        {
            ConnectionString = "192.168.160.131";
            _connMultiplexer = ConnectionMultiplexer.Connect(ConnectionString);
            DefaultKey = "Jabo";
            AddRegisterEvent();
        }
        ...
        {
            redisKey = AddKeyPrefix(redisKey);
            var json = ProtoBufHelper.Serialize(redisValue);
        ...
        {
            redisKey = AddKeyPrefix(redisKey);
            return ProtoBufHelper.DeSerialize<T>(_db.StringGet(redisKey));
        }
        ...
        {
            redisKey = AddKeyPrefix(redisKey);
            return ProtoBufHelper.DeSerialize<T>(await _db.StringGetAsync(redisKey));
        }
        ...
        public T HashGet<T>(string redisKey, string hashField)
        {
            ...
            return ProtoBufHelper.DeSerialize<T>(_db.HashGet(redisKey, hashField));
        }
        ...
        {
            redisKey = AddKeyPrefix(redisKey);
            var json = ProtoBufHelper.Serialize(value);
        ...
        {
            redisKey = AddKeyPrefix(redisKey);
            return ProtoBufHelper.DeSerialize<T>(await _db.HashGetAsync(redisKey, hashField));
        }
        ...
        {
            redisKey = AddKeyPrefix(redisKey);
            return ProtoBufHelper.DeSerialize<T>(_db.ListLeftPop(redisKey));
        }
        ...
        {
            redisKey = AddKeyPrefix(redisKey);
            return ProtoBufHelper.DeSerialize<T>(_db.ListRightPop(redisKey));
        }
        ...
        {
            redisKey = AddKeyPrefix(redisKey);
            return _db.ListRightPush(redisKey, ProtoBufHelper.Serialize(redisValue));
        }
        ...
        {
            redisKey = AddKeyPrefix(redisKey);
            return _db.ListLeftPush(redisKey, ProtoBufHelper.Serialize(redisValue));
        }
        ...
        {
            redisKey = AddKeyPrefix(redisKey);
            return ProtoBufHelper.DeSerialize<T>(await _db.ListLeftPopAsync(redisKey));
        }
        ...
        {
            redisKey = AddKeyPrefix(redisKey);
            return ProtoBufHelper.DeSerialize<T>(await _db.ListRightPopAsync(redisKey));
        }
        ...
        {
            redisKey = AddKeyPrefix(redisKey);
            return await _db.ListRightPushAsync(redisKey, ProtoBufHelper.Serialize(redisValue));
        }
        ...
        {
            redisKey = AddKeyPrefix(redisKey);
            return await _db.ListLeftPushAsync(redisKey, ProtoBufHelper.Serialize(redisValue));
        }
        ...
        {
            redisKey = AddKeyPrefix(redisKey);
            var json = ProtoBufHelper.Serialize(member);
