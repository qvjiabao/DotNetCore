    ...
    internal class LogLevel
    {
        ...
        public string LogApi
        {
            get
            {
                ...
                {
                    case "Trace":
                        return "http://localhost:5000/Log/Trace";
                    case "Debug":
                        return "http://localhost:5000/Log/Debug";
                    case "Info":
                        return "http://localhost:5000/Log/Info";
                    case "Warn":
                        return "http://localhost:5000/Log/Warn";
                    case "Error":
                        return "http://localhost:5000/Log/Error";
                    case "Fatal":
                        return "http://localhost:5000/Log/Fatal";
                    default:
                        return "";
                }
            }
